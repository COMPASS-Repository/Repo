...
def generate_prompt(row):
    ...
    base_prompt = (
           f"Role: You are a senior security analyst specializing in vulnerability patching patterns. \n"
            ...
            "     a. Determine if it fixes the CVE directly.\n"
            ...
            "\n"
            "Ensure every patch in the input patch group should participate in at least one relationship instance, except for patches that have been identified as not contributing to the vulnerability fixing.\n"
